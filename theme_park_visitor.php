    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav center">
          ...
          <a class="nav-link active" aria-current="page" href="http://localhost/myProject/theme_park_visitor.php">Find Theme Parks</a>
          <a class="nav-link" href="http://localhost/myProject/home_page_visitor.php">Home</a>
