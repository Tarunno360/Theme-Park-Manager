...
.card__thumbnail > .card__title{ /* Just for styling */
  position: absolute; left: 30px; bottom:760px ; }
               ...
               <div class="column"> 
                <div class="card">
                  ...
                  <figure class="card__thumbnail">
                    ...
                    <span class="card__title">'.$r["park_name"].'<h3>This park is located at '.$r["location"].'</h3><h5>Park ID: '.$r["park_id"].'</h5></span>
