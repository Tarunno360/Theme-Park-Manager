    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav center">
          <a class="nav-link active" aria-current="page" href="http://localhost/myProject/home_page_visitor.php">Home</a>
          <a class="nav-link "  href="ticket_visitor.php">Buy Tickets</a>
          <a class="nav-link" href="http://localhost/myProject/theme_park_visitor.php">Theme Parks</a>
        ...
        <section id="pic01">
            ...
            <div class="container">
              ...
              <br>
               ...
               <h2 class='checkout'>Check out your favourite <a class='checkout' href="theme_park_visitor.php">Parks</a> and <a class='checkout' href="rides_visitor.php">Rides</a> with us!</h2>
               </div>
      ...
      <div class="header-container">
        <div>
          <h1>WHAT WE DO</h1>
          <p class = 'desc'>
            Theme parks are places where imagination meets
            adventure. We will help you thrill-seekers find the most
            exhilarating rides and immersive attractions to enchanting themed
            lands that will create memories
            to last a lifetime. You can find all your favourite rides from all your favourite parks located near you through our website.
          </p>
        </div>
